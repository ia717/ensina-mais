...
<body class="relative bg-gray-100">
    <header id="inicio" class="bg-gray-100 shadow z-10">
        <div class="container mx-auto px-4 py-2 flex flex-col md:flex-row justify-between items-start space-y-2 md:space-y-0">
    ...
    <section class="bg-sky-800 shadow-md p-1 mb-16 py-1.5 z-20">
        <nav class="flex flex-col md:flex-row md:space-x-28 justify-center">
    ...
    <!-- Main Content -->
    <main class="container mx-auto mt-8 p-4 flex flex-col md:flex-row space-y-8 md:space-x-8">
        <!-- Login Form -->
        <div class="bg-white shadow-lg rounded-3xl p-8 md:w-1/3 w-full z-10">
        ...
        <!-- Promotional Section -->
        <div class="relative bg-white shadow-lg rounded-3xl md:w-2/3 w-full overflow-hidden z-10">
            <video autoplay muted loop playsinline src="{{asset('videos/Para Gabaritar.mp4')}}" class="w-full"></video>
        </div>
    </main>
    ...
    <section class="mt-56 container mx-auto flex flex-col justify-center gap-40 mb-32 bg-white pt-24">
        <div class="flex items-center justify-center">
            ...
            <div class="reveal bg-sky-800 text-white rounded-3xl px-1 py-10 ml-32 mt-8 flex flex-col md:flex-row items-center justify-around relative">
                ...
                <div class="mx-10 flex-1 text-center">
                    ...
                    <p class="font-medium">questões no repertório</p>
                </div>
                <div class="mx-10 flex-1 text-center">
        ...
        <div class="reveal container justify-center items-center flex z-10">
            ...
            <div class="flex flex-col md:flex-row space-x-0 md:space-x-20 mx-10 md:mx-20">

                <div class="font-medium text-1xl bg-white shadow-lg rounded-3xl p-6 w-full md:w-1/3 z-10 mb-6 md:mb-0">
                ...
                <div class="font-medium text-1xl bg-white shadow-lg rounded-3xl p-6 w-full md:w-1/3 z-10">
                    <ul class="text-lg list-disc pl-4 space-y-2 text-gray-700">
...
<div class="flex justify-between top 1/2 absolute">
            <button id="prev" class="z-40 relative left-40 top-1/2 transform -translate-y-1/2 px-2.5 pb-1.5 bg-none text-sky-500 text-6xl rounded-full font-medium pt-80 mt-36 hover:text-sky-800 transition-all duration-75"><</button>
            <button id="next" class="z-40 relative right-40 top-1/2 transform -translate-y-1/2 px-2.5 pb-1.5 bg-none text-6xl rounded-full font-medium pt-80 text-sky-500 mt-36 hover:text-sky-800 transition-all duration-75">></button>
        </div>
    <!-- TURBINA -->
            ...
            <div class="mt-2 ml-5">
                ...
                <div>
                    <a target="blank" href="https://www.youtube.com/watch?v=xvFZjo5PgG0">
                        <button class="transition-all duration-75 text-lg mt-20 font-medium w-auto bg-yellow-500 text-black py-2 px-8 rounded-md hover:bg-yellow-600 subpixel-antialiased">Saiba Mais</button>
                    </a>
                </div>
            </div>
        </div>
    ...
    <a id="scrollToTop" class="fixed right-2 bottom-2 z-[1000] bg-sky-800 p-2 rounded-full px-4 text-white transition-opacity duration-300 ease-in-out opacity-0 hover:text-sky-500 font-bold text-xl no-underline border border-white" href="#inicio">^</a>
    <button id="toggle-dark-mode" class="fixed z-[1000] bottom-4 left-4 px-4 py-2 bg-sky-800 text-white rounded border hover:text-sky-500 border-white">Alternar Modo</button>
