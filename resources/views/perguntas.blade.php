...
<main class="items-center justify-center flex min-h-screen">
        <div class="bg-white dark:bg-neutral-800 rounded-lg shadow-lg p-6 max-w-4xl w-full justify-center items-center">
            ...
            <div class="flex flex-col md:flex-row space-y-6 md:space-y-0 md:space-x-6">
                <!-- FAQ Container -->
            <div class="flex-col bg-gray-500">  
                <details class="mb-4 bg-gray-500  rounded-lg p-4">
                    <summary class="cursor-pointer text-lg font-medium">O que fazer se o site estiver fora do ar ou lento?</summary>
                    <p class="mt-2 text-gray-600">Verifique a Conexão: Certifique-se de que sua conexão com a internet está estável <br>
                ...
                <details class="mb-4 bg-gray-500  rounded-lg p-4">
                    ...
                    <p class="mt-2 text-gray-600">Sim, você pode personalizar seu plano de estudos! O site oferece ferramentas que permitem <br>
                ...
                <details class="mb-4 bg-gray-500  rounded-lg p-4">
                    ...
                    <p class="mt-2 text-gray-600">Sim, o site oferece conteúdo para todos os níveis de aprendizado! Há materiais disponíveis desde o nível <br>
                ...
                <details class="mb-4 bg-gray-500 rounded-lg p-4">
                    ...
                    <p class="mt-2 text-gray-600">VPara alterar suas informações pessoais, acesse a seção de configurações ou perfil do site, onde você encontrará uma opção para editar dados como nome, e-mail e outras informações pessoais. <br>
                     Caso precise de ajuda, consulte o suporte ou a central de ajuda do site para obter orientações detalhadas.
                    </p>
                </details>
                <details class="mb-4 bg-gray-800  rounded-lg p-4">
