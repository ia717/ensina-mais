            ...
            <div class="flex-col ">
                <details class="mb-4 bg-gray-300  rounded-lg p-4">
                    ...
                    <p class="mt-2 text-gray-600">
                        Verifique a Conexão: Certifique-se de que sua conexão com a internet está estável <br>
                ...
                <details class="mb-4 bg-gray-300  rounded-lg p-4">
                    ...
                    <p class="mt-2 text-gray-600">
                        Sim, você pode personalizar seu plano de estudos! O site oferece
                        ferramentas que permitem <br>
                        adaptar o plano às suas necessidades, ajustando o conteúdo, o tempo de estudo e as metas de
                        acordo com seus objetivos pessoais. <br>
                        Isso facilita o acompanhamento do progresso e ajuda a manter o foco nas áreas mais importantes
                        para você.
                    </p>
                </details>
                <details class="mb-4 bg-gray-300  rounded-lg p-4">
                    ...
                    <p class="mt-2 text-gray-600">
                        Sim, o site oferece conteúdo para todos os níveis de aprendizado! Há
                        materiais disponíveis desde o nível <br>
                        iniciante até o avançado, cobrindo diferentes temas e habilidades. <br>
                        Assim, você pode evoluir no seu próprio ritmo, acessando recursos adaptados ao seu conhecimento
                ...
                <details class="mb-4 bg-gray-300 rounded-lg p-4">
                    ...
                    <p class="mt-2 text-gray-600">
                        Para alterar suas informações pessoais, acesse a seção de
                        configurações ou perfil do site, onde você encontrará uma opção para editar dados como nome,
                        e-mail e outras informações pessoais. <br>
                        Caso precise de ajuda, consulte o suporte ou a central de ajuda do site para obter orientações
                        detalhadas.
                    </p>
                </details>
                <details class="mb-4 bg-gray-300  rounded-lg p-4">
                    ...
                    <p class="mt-2 text-gray-400">
                        Sim, o site permite estimar o tempo de aprendizado com base no seu
                        plano de estudos e nas metas definidas. <br>
                        Através de ferramentas que monitoram seu progresso e o tempo investido, você consegue ter uma
                        ideia aproximada de quanto tempo será necessário para atingir seus objetivos. <br>
