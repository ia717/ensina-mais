                ...
                <div class="flex items-center justify-between">
                    <div class="flex items-center justify-start rtl:justify-end">
                        ...
                        <a href="https://flowbite.com" class="flex ms-2 md:me-24">
                            <img src="{{ asset('images/logo ensina claro.png') }}" class="h-8 me-3" alt="FlowBite Logo" />
        ...
        <aside id="logo-sidebar" class="fixed top-0 left-0 z-40 w-64 h-screen pt-8 transition-transform -translate-x-full bg-white border-r border-gray-200 sm:translate-x-0 dark:bg-neutral-800 dark:border-neutral-700 rounded-r-3xl" aria-label="Sidebar">
            <div class="h-full px-3 pb-4 overflow-y-auto bg-white dark:bg-neutral-800">
                ...
                <ul class="space-y-2 font-medium">
                    ...
                    <li>
                        <a href="arealuno" class="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group">
                        <i class="fas fa-user-graduate mr-2"></i>
                            <span class="flex-1 ms-3 whitespace-nowrap">Área do Aluno</span>
                        </a>
                    </li>
                    <li>
                        <a href="calendario" class="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group">
                            <i class="fas fa-calendar-alt mr-2"></i>
                            <span class="flex-1 ms-3 whitespace-nowrap">Calendário</span>
                        </a>
                    </li>
                    <li>
                        <a href="cronograma" class="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group">
                    ...
                    <li>
                        <a href="simulados" class="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group">
                    ...
                    <li>
                        <a href="redacao" class="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group">
                        <i class="fas fa-file-alt mr-2"></i>
                            <span class="flex-1 ms-3 whitespace-nowrap">Redação</span>
                        </a>
                    </li>
                    <li>
                        <a href="{{ route('questao.index') }}" class="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group">
                        <i class="fas fa-question-circle mr-2"></i>
                            <span class="flex-1 ms-3 whitespace-nowrap">Questões</span>
                        </a>
                    </li>
                    <li>
                        <a href="perguntas" class="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group">
