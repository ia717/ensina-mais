...
<x-app-layout>
    <div class="max-w-3xl absolute right-96 z-50 dark:bg-neutral-800 mx-auto bg-white p-6 rounded-lg shadow-lg">
        ...
        <div class="space-y-4 mb-2.5">
            <!-- Card de dúvida 1 -->
            <div class="bg-gray-50 p-4 max-w-4xl rounded-lg shadow mb-2.5 border-2 border-pink-500 question-card" data-discipline="Gramatica">
                ...
                <div id="answer1" class="mt-2 hidden transition-all duration-300 ease-in-out">
                    <hr class="my-5">
            ...
            <div class="bg-gray-50 p-4 rounded-lg shadow mb-2.5 border-2 border-orange-500 question-card" data-discipline="Matemática">
                ...
                <div id="answer2" class="mt-2 hidden transition-all duration-300 ease-in-out">
                    <hr class="my-5">
            ...
            <div class="bg-gray-50 p-4 rounded-lg shadow mb-2.5 border-2 border-yellow-500 question-card" data-discipline="História">
                ...
                <div id="answer3" class="mt-2 hidden transition-all duration-300 ease-in-out">
                    <hr class="my-5">
