...
<body class="h-screen">
    <div class="flex h-full">
        ...
        <main class="flex-1 flex flex-col">
            ...
            <!-- Question Card -->
            <div class="max-w-7xl w-full mx-auto flex-grow flex">
                ...
                <div class="flex-1 p-4">
                    <!-- Question Content -->
                    <div class="bg-white p-8 rounded-3xl shadow-lg transition duration-300 hover:shadow-xl">
                        ...
                        <div class="bg-[#efb9bc] border-2 p-8 rounded-3xl space-y-6 mt-4">
                            ...
                            <div class="text-center bg-pink-200 py-4 rounded-xl">
                ...
                <div class="hidden lg:flex flex-shrink-0 w-full left-full">
