...
<body>
    <div>
        ...
        <p class="text-3xl text-black fontbold pl-2 mt-7">Matemática Básica</p>


    <div class="absolute flex flex-col top-20 left-80 space-y-5">
        <div class="items-center flex justify-between p-4 border-2 border-purple-500  rounded-lg shadow-md max-w-4xl mx-auto h-40">
            <!-- Ícone e Conteúdo -->
            <div class="space-x-4">
                <!-- Ícone -->
                ...
                <!-- Texto e Data -->
                <div class="pr-96">
                    <p class="text-lg font-bold text-gray-800">Conteúdo</p>
