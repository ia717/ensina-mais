<div class="drawer drawer-end lg:drawer-open mr-96">
  ...
  <div class="drawer-side">
    ...
    <h2 class="text-xl font-medium mb-4">Filtrar Simulados</h2>
    <div class="space-y-4">
      <div>
        <label for="disciplina" class="block mb-1">Disciplina</label>
        <input type="text" id="palavraschave" class="rounded-lg" placeholder="Buscar por disciplinas">
      </div>
      <div>
        <label for="tipo" class="block mb-1">Universidade</label>
