...
<body class="relative bg-gray-100 user-select-none">
    ...
    <main class="container mx-auto mt-8 p-0 md:p-0 md:flex md:space-x-8 space-y-0 md:space-y-0 m-0">
        ...
        <div
            class="relative bg-white shadow-lg rounded-3xl w-full md:w-2/3 overflow-hidden md:ml-6 z-10 order-1 md:order-2 space-y-4 md:space-y-2 mt-0">
            <video class="w-full" autoplay muted loop playsinline
                src="{{ asset('videos/Para Gabaritar.mp4') }}"></video>
        </div>
        <!-- Login Form -->
    ...
    <!-- Section Title -->
    <section
        class="mt-20 md:mt-56 container mx-auto flex flex-col justify-center gap-20 md:gap-40 bg-white pt-10 md:pt-24">
        <div class="flex flex-col md:flex-row items-center justify-center">
            ...
            <div>
                <img class="absolute left-0 -mt-10 hidden md:block" src="{{ asset('/imagens/Vector (4).png') }}"
                    alt="">
            </div>

            <div>
                <img class="reveal absolute left-36 top-96 pt-10 mt-5 md:pt-20 md:mt-10 hidden md:block"
                    src="{{ asset('/imagens/Vector (5).png') }}" alt="">
            </div>

            <div>
                <img class="reveal absolute left-2/3 ml-56 -mt-10 hidden md:block"
                    src="{{ asset('/imagens/Vector (3).png') }}" alt="">
            </div>

            <!-- Statistics Section -->
            <div
                class="reveal bg-sky-800 text-white rounded-3xl px-2 py-5 md:py-10 mt-8 w-full md:w-auto flex flex-col md:flex-row items-center justify-around relative space-y-4 md:space-y-0">
        ...
        <h3 class="reveal text-5xl font-bold text-black justify-center items-center flex subpixel-antialiased"
            id="sobre">Sobre nós <span class="text-sky-800">+</span></h3>
            ...
            <div class="flex space-x-20 mx-20">
                <div class="font-medium text-1xl bg-white shadow-lg rounded-3xl p-6 w-1/3 z-10">
                    <ul class="text-lg list-disc pl-4 space-y-2 text-gray-700">
                        ...
                        <li class="py-2 subpixel-antialiased">Combina conteúdos teóricos, exercícios, videoaulas e
                            simulados</li>
                    </ul>
                </div>
                <div class="font-medium text-1xl bg-white shadow-lg rounded-3xl p-6 w-1/3 z-10">
                    <ul class="text-lg list-disc pl-4 space-y-2 text-gray-700">
                        ...
                        <li class="py-2 subpixel-antialiased">Oferece um ambiente de aprendizado interativo e acessível
                        </li>
                    </ul>
                </div>
                <div class="font-medium text-1xl bg-white shadow-lg rounded-3xl p-6 w-1/3 z-10">
        ...
        <div class="relative overflow-hidden w-full max-w-5xl mx-auto">
            <div id="carousel" class="reveal flex transition-transform duration-300 ease-out">
                ...
                <div class="flex-shrink-0 flex min-w-full space-x-0 ml-5">
                    <span><img src="{{ asset('imagens/teste marcela.png') }}" alt=""
                            class=" h-40 md:h-80 w-40 md:w-80"></span>
                    <img src="{{ asset('imagens/teste cogh.png') }}" alt=""
                        class=" h-40 md:h-80 w-40 md:w-80">
                    <img src="{{ asset('imagens/teste joao.png') }}" alt=""
                        class=" h-40 md:h-80 w-40 md:w-80">
                </div>

                <!-- Second Slide -->
                <div class="flex-shrink-0 flex min-w-full space-x-0 mb-20">
                    <img src="{{ asset('imagens/teste eduarda.png') }}" alt=""
                        class=" h-40 md:h-80 w-40 md:w-80">
                    <img src="{{ asset('imagens/teste pedro.png') }}" alt=""
                        class=" h-40 md:h-80 w-40 md:w-80">
                    <img src="{{ asset('imagens/teste everton.png') }}" alt=""
                        class=" h-40 md:h-80 w-40 md:w-80">
                </div>
            </div>
            ...
            <div class="absolute left-10 top-1/2 transform -translate-y-1/2">
                <button id="prev"
                    class="transform px-2.5 pb-1.5 bg-none text-sky-500 text-6xl rounded-full font-medium hover:text-sky-800 hover:px-2 transition-all duration-75">
        ...
        <section id="aluno" class="reveal flex justify-center bg-white my-20 p-20">
            <div class="flex flex-col items-start w-1/2 gap-8">
                ...
                <p class="text-xl text-gray w-3/4">Garanta uma preparação de excelência para o vestibular! Somos
                    referência nacional em
                    educação e preparação para vestibular.</p>
                <a href="#"
                    class="transition-all duration-75 bg-sky-800 subpixel-antialiased text-lg text-white font-semibold rounded-md hover:bg-sky-500 hover:px-6 p-4">Conheça
        ...
        <a id="scrollToTop"
            class="fixed right-2 bottom-2 z-40 bg-sky-800 rounded-full text-white transition-opacity duration-300 ease-in-out opacity-0 hover:text-sky-500 font-bold text-xl no-underline border border-white"
            href="#inicio"><svg height="40px" width="40px" version="1.1" id="Layer_1"
                xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="0 0 512 512"
                xml:space="preserve" fill="#000000" class="transition-all hover:h-11 hover:w-11"
