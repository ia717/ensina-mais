...
<main class="rounded-md  dark:bg-neutral-900 p-6 space-y-8">
    
    
<div class="flex items-center bg-white border dark:bg-neutral-700 border-gray-300 rounded-full px-4 py-2 w-full max-w-md">
    <input 
      type="text" 
      placeholder="Pesquisar..." 
      class="w-full outline-none border-none text-gray-700 px-2 bg-transparent"
    />
  
  </div>
        <aside class="flex-col bg-white text-start dark:bg-neutral-700  rounded-md ">
            <h1 class="text-3xl font-bold mb-8 text-start dark:text-white text-gray-800">Provas Anteriores-ENEM</h1>
             <div class=" rounded-lg flex w-full text-start md:w-50    mx-auto">
                ...
                <div class="flex flex-col md:flex-row justify-start  items-start mb-6">
                    <div class="bg-gray-300 text-black font-semibold dark:bg-neutral-600 dark:text-white  text-lg text-start flex justify-start items-start flex-col p-6 rounded-lg shadow-md hover:shadow-lg transition-shadow mx-4">
                ...
                <div class="flex flex-col md:flex-row justify-start items-start mb-6">
                    <div class="bg-gray-300 text-black font-semibold dark:bg-neutral-600 dark:text-white text-lg flex justify-center items-start flex-col p-6 rounded-lg shadow-md hover:shadow-lg transition-shadow mx-4">
        ...
        <aside class="flex-col bg-white text-start dark:bg-neutral-700 dark:text-white rounded-md ">
        <h1 class="text-3xl font-bold mb-8 text-start dark:text-white text-gray-800">Provas Anteriores-FUVEST</h1>
            <div class=" rounded-lg flex w-full  mx-auto">
        ...
        <aside class="flex-col bg-white dark:bg-neutral-700 text-start dark:text-white rounded-md ">
        <h1 class="text-3xl font-bold mb-8 text-start dark:text-white text-gray-800">Provas Anteriores-FATEC</h1>
            <div class=" rounded-lg flex w-full  mx-auto">
        ...
        <aside class="flex-col bg-white text-start dark:bg-neutral-700 dark:text-white rounded-md ">
        <h1 class="text-3xl font-bold mb-8 text-start dark:text-white text-gray-800">Provas Anteriores-UNESP</h1>
            <div class=" rounded-lg flex w-full  mx-auto">
